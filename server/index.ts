...
function buildSitemapXml(): string {
  ...
  const staticPaths = [
    ...
    { path: "/blog/market-analysis/best-options-scanners-compared-2025", priority: "0.7", changefreq: "weekly" },
    { path: "/tools/iv-rank-calculator", priority: "0.7", changefreq: "weekly" },
    { path: "/tools/earnings-calendar", priority: "0.7", changefreq: "weekly" },
