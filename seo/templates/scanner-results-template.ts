...
<body>
  ...
  <footer>
    <p>&copy; ${new Date().getFullYear()} Gistify.pro &mdash; <a href="/">Home</a> &middot; <a href="https://gistify.pro">App</a></p>
  </footer>
...
export function generateScannerResultsHTML(
  ...
  const ogImage = `https://gistify.pro/gistifylogo.png?v=20260706`;
  ...
  const schema = {
    ...
    publisher: {
      '@type': 'Organization',
      name: 'Gistify',
      logo: { '@type': 'ImageObject', url: 'https://gistify.pro/gistifylogo.png?v=20260706' },
    },
