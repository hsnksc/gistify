          ...
          <table className="w-full text-sm">
            <thead>
              <tr style={{ borderBottom: '2px solid oklch(0.22 0.03 225)', background: 'oklch(0.13 0.025 230)' }}>
                {['Sıra', 'Hisse', 'Rating', 'IV Crush Skoru', 'Yönsel Ağırlık', 'Mevcut IV', 'Beklenen IV Crush', 'Hedef Kar', 'Risk', 'Strateji'].map(h => (
            ...
            return (
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-2 mb-3">
                  ...
                  <div>
                    <div className="text-xs" style={{ color: 'oklch(0.4 0.015 225)' }}>Yönsel Neden</div>
