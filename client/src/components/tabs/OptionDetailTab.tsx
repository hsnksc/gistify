    ...
    <div className="p-6 space-y-4">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <div className="flex items-center gap-3 mb-1">
              ...
              >
                YÖN: {stock.directionalBias} %{stock.biasStrength}
              </span>
            </div>
      ...
      <div className="tactical-card p-4" style={{ borderLeftColor: stock.directionalBias === 'CALL' ? 'oklch(0.78 0.18 160)' : stock.directionalBias === 'PUT' ? 'oklch(0.65 0.22 25)' : 'oklch(0.75 0.15 75)' }}>
        <div className="flex items-center gap-2 mb-3">
          <div className="heading-condensed text-sm" style={{ color: 'oklch(0.92 0.01 220)' }}>YÖNSEL ANALİZ & MOMENTUM GEREKÇESİ</div>
          <div className="flex-1 h-[1px]" style={{ background: 'oklch(0.22 0.03 225)' }} />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="space-y-3">
            <div>
              <div className="text-[10px] uppercase font-bold mb-1" style={{ color: 'oklch(0.45 0.015 225)' }}>Ağırlıklı Yön</div>
          ...
          <div className="md:col-span-2">
            <div className="text-[10px] uppercase font-bold mb-1" style={{ color: 'oklch(0.45 0.015 225)' }}>Analiz Özeti</div>
            <p className="text-sm leading-relaxed" style={{ color: 'oklch(0.85 0.01 220)' }}>
              {stock.biasReason} Momentum skoru ({stock.momentumScore}/100) ve RSI-14 ({stock.rsi14}) verileri ışığında, 15 gün öncesinden kurulacak pozisyonlarda 
              <strong style={{ color: stock.directionalBias === 'CALL' ? 'oklch(0.78 0.18 160)' : stock.directionalBias === 'PUT' ? 'oklch(0.65 0.22 25)' : 'oklch(0.75 0.15 75)' }}>
                {' '}{stock.directionalBias}{' '}
              </strong> 
              tarafının %{stock.biasStrength} olasılıkla daha avantajlı olduğu değerlendirilmektedir.
            </p>
          </div>
        </div>
      </div>
